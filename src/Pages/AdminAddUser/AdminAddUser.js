...
import { CapNhapThongTinNguoiDungAction, LayDanhSachNguoiDung, ThemNguoiDungAction, TimKiemNguoiDungAction } from '../../Redux/Actions/QuanLyNguoiDungAction'
import {
    EyeOutlined,
        ...
        <>
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <input type="text" className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none " name="taiKhoan" value={formik.values.taiKhoan} onChange={formik.handleChange} placeholder="Tài khoản" />
                </div>
                {/* Password input */}
                <div className="mb-6 relative">
                    ...
                    {typePassword ? <button type='button' onClick={() => { setTypePassword(!typePassword) }} className='absolute  right-3 top-8'><EyeInvisibleOutlined /></button> :
                        <button type='button' onClick={() => { setTypePassword(!typePassword) }} className='absolute  right-3 top-8'>< EyeOutlined /></button>}
                </div>
                {/* Email input */}
                <div className="mb-6">
