        ...
        <header className=" bg-gray-600 bg-opacity-70 text-gray-900 fixed w-full h-auto z-10">
            <div className="container flex justify-between h-16 mx-auto">
                <div className=" flex justify-start items-center w-2/3">
                    ...
                    <ul className="items-stretch ml-6 mb-0 hidden space-x-3 lg:flex">
                        <li className="flex">
                        ...
                        <li className="flex">
                            <NavLink to='/contact' activeClassName='  text-violet-400' className="flex text-base items-center px-4 -mb-1 text-white hover:text-violet-400 transition-all duration-500">Movies</NavLink>
                        </li>
                        <li className="flex">
                            <NavLink to='/news' activeClassName='  text-violet-400' className="flex text-base items-center px-4 -mb-1 text-white hover:text-violet-400 transition-all duration-500">Showtimes</NavLink>
                        </li>
